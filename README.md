...
### 🛡️ 四維刻意練習給星機制
* **四維給星獎勵**：全面廢除時間凍結盾，改為以下純星等獎勵（自動與 Supabase 雲端排行榜同步）：
  1. **連續上線獎 (7-Day Streak)**：連續 7 天上線玩、且每天玩滿至少 5 個 Stage，自動發放 **5 顆星**。
  2. **完美連斬獎 (20-Combo)**：單局內連續答對 20 題（無中斷），結算時加發 **1 顆星**。
  3. **百題斬成就 (100-Correct)**：累計答對題目每滿 100 題，自動加發 **1 顆星**。
  4. **錯題消滅獎 (10-Error-Cleared)**：錯題消除模式中累計消除 10 題錯題，自動加發 **1 顆星**。
